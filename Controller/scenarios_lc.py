...
class simpleLaneChange: 
    ...
    '''
    def __init__(self, min_distx = 5, lanes = 3, laneWidth = 3.5):
        ...
        self.pxL = MX.sym('pxL',1)
        self.px = MX.sym('x',1)

        self.traffic_x = MX.sym('x',1)
        self.traffic_y = MX.sym('y',1)
        self.traffic_sign = MX.sym('sign',1)
        self.traffic_shift = MX.sym('shift',1)
