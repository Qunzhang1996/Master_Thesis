...
class makeDecisionMaster:
    ...
    def chooseController(self):
        ...
        #! np.array for the trajectory of ego  vehicle for three controllers
        trajectory_save = np.zeros((3,self.nx,self.N+1))
        ...
        return u_ok, x_ok, X, decision_i, trajectory_save
