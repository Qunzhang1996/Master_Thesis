...
class simpleOvertake:
    ...
    def constrain_tightened(self,traffic,opts,temp_x, tempt_y):
        ...
        for i in range(traffic.getDim()):
            ...
            alpha_1 = l_rear + self.L_tract/2 + v0_i * self.Time_headway + self.min_distx  # this is for the end
            alpha_2 = l_front + self.L_tract/2 + v0_i * self.Time_headway+ self.min_distx  # this is for the front
            alpha_3 = self.traffic_shift
            d_w_e = (self.egoWidth/2+d_lat_spread)*self.traffic_sign
            # Construct function
