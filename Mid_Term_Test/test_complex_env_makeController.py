...
############################################################################################
#! here change the controller type to "casadi"/"ACADOS" to use the corresponding controller
...
def main_casadi():
    ...
    MPC_LC= makeController(vehicleADV,traffic,scenarioADV,N,opts1,dt,controller_type)
    MPC_LC.setController()
    #TODO: MPC_LC.setController()

    opts2 = {"version" : "rightChange", "solver": "ipopt", "integrator":"LTI"}
    MPC_RC= makeController(vehicleADV,traffic,scenarioADV,N,opts2,dt,controller_type)
...
def main_acados():
    ...
    scenarioTrailADV.slackCost(q_traffic_slack)
    scenarioADV.slackCost(q_traffic_slack)
    vehicleADV.setAcadosSlack(q_traffic_slack)
