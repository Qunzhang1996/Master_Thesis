...
/* rockit_model_cost_ext_cost_e_fun_jac_hess:(i0[4],i1[],i2[],i3[7])->(o0,o1[4],o2[4x4,2nz],o3[],o4[0x4]) */
static int casadi_f0(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem) {
  casadi_int i;
  casadi_real *rr, *ss;
  const casadi_real *cs;
  casadi_real w0, w1, *w2=w+2, *w3=w+4, *w6=w+6, *w7=w+10;
  /* #0: @0 = input[0][0] */
  w0 = arg[0] ? arg[0][0] : 0;
  /* #1: @1 = input[0][1] */
  w1 = arg[0] ? arg[0][1] : 0;
  ...
  *rr++ = w1;
  ...
  /* #24: (@2[:2] = @7) */
  for (rr=w2+0, ss=w7; rr!=w2+2; rr+=1) *rr = *ss++;
  /* #25: @7 = @3[:2] */
  for (rr=w7, ss=w3+0; ss!=w3+2; ss+=1) *rr++ = *ss;
  /* #26: (@2[:2] = @7) */
  for (rr=w2+0, ss=w7; rr!=w2+2; rr+=1) *rr = *ss++;
  /* #27: @7 = @2' */
  casadi_trans(w2,casadi_s1, w7, casadi_s1, iw);
  /* #28: output[2][0] = @7 */
