...
local_controller = VehiclePIDController(truck, 
                                        args_lateral = {'K_P': 1.95, 'K_I': 0.05, 'K_D': 0.2, 'dt': desired_interval}, 
...
for i in range(1000):
    ...
    if i%5==0:
        ...
        u_opt, x_opt,lambda_s,tightened_IDM_constraints= mpc_controller.solve(x_iter, ref_trajectory, ref_control, 
                                                      p_leading, velocity_leading)
        print(f"current control sttae of the truck is: {x_opt}")
